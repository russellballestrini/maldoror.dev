 ...
 * Context Builder
 *
 * Convert world observations into LLM-friendly context strings.
 */

import type { CharacterObservation } from './types.js';

export function buildContext(obs: CharacterObservation): string {
